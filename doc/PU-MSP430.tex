...
\paragraph{2.1.1.2. Parameters}\label{parameters}}

\hypertarget{basic-system-configuration}{%
\subparagraph{2.1.1.2.1. Basic System
...
\subparagraph{2.1.1.2.2. Advanced System Configuration (for experienced
...
\subparagraph{2.1.1.2.3. Expert System Configuration (experts
...
\subparagraph{2.1.1.2.4. ASIC System Configuration
...
\subparagraph{2.1.1.2.5. System Constants (do not
...
\paragraph{2.1.2.1. Instruction Inputs/Outputs
Bus}\label{instruction-inputsoutputs-bus}}

\hypertarget{data-inputsoutputs-bus}{%
\paragraph{2.1.2.2. Data Inputs/Outputs
